...
branches:
  ...
  it("CompareDeep Test when target is from the api", () => {
    const protection = {
      ...
      required_status_checks: {
        ...
        contexts: [],
        contexts_url:
          "https://api.github.com/repos/decyjphr-org/test/branches/develop/protection/required_status_checks/contexts",
        checks: [],
      },
      restrictions: {
        url: "https://api.github.com/repos/decyjphr-org/test/branches/develop/protection/restrictions",
        users_url:
          "https://api.github.com/repos/decyjphr-org/test/branches/develop/protection/restrictions/users",
        teams_url:
          "https://api.github.com/repos/decyjphr-org/test/branches/develop/protection/restrictions/teams",
        apps_url:
          "https://api.github.com/repos/decyjphr-org/test/branches/develop/protection/restrictions/apps",
        users: [],
        teams: [],
        apps: [],
      },
      required_pull_request_reviews: {
        ...
        dismissal_restrictions: {
          ...
          users_url:
            "https://api.github.com/repos/decyjphr-org/test/branches/develop/protection/dismissal_restrictions/users",
          teams_url:
            "https://api.github.com/repos/decyjphr-org/test/branches/develop/protection/dismissal_restrictions/teams",
          users: [],
          teams: [],
        },
      },
  ...
  it("Merge labels with ignorable extra info Works", () => {
    const source = {
      entries: [
        {
          id: 3954990840,
          node_id: "LA_kwDOHC6_Gc7rvF74",
          url: "https://api.github.com/repos/decyjphr-org/test2/labels/bug",
          name: "bug",
          color: "CC0000",
          default: true,
        ...
        {
          id: 4015763857,
          node_id: "LA_kwDOHC6_Gc7vW7GR",
          url: "https://api.github.com/repos/decyjphr-org/test2/labels/feature",
          name: "feature",
          color: "336699",
          default: false,
        ...
        {
          id: 4015763934,
          node_id: "LA_kwDOHC6_Gc7vW7He",
          url: "https://api.github.com/repos/decyjphr-org/test2/labels/first-timers-only",
        ...
        {
          id: 4015763984,
          node_id: "LA_kwDOHC6_Gc7vW7IQ",
          url: "https://api.github.com/repos/decyjphr-org/test2/labels/new-label",
          name: "new-label",
          color: "326699",
          default: false,
          description: null,
    ...
    const target = {
      entries: [
        ...
        { name: "first-timers-only", oldname: "Help Wanted", color: "326699" },
  ...
  it("Compare nested arrays deep", () => {
    const source = {
      colors: [
        ...
        { name: "newone", color: "red" },
        { name: "uber", color: "yellow" },
      ],
    };
    const target = {
      colors: [
        { name: "blue", color: "blue", anotherArray: [1, 2, 3] },
        { name: "blu", color: "blu" },
      ],
    };
  ...
  it("Merge array of topics", () => {
    const source = {
      entries: ["blue", "green", "newone", "red", "uber", "yellow"],
    };
  ...
  - name: new
    ...
    const expected = JSON.parse(
      `{"additions":{"x":[{"name":"new","values":{"a":["b"]}}]},"modifications":{"x":[{"values":{"a":["b"]},"name":"default"}]},"hasChanges":true}`
    );
    const ignorableFields = [];
    const mockReturnGitHubContext = jest.fn().mockReturnValue({
      request: () => {},
...
- key_prefix: BOLIGRAFO-
  ...
  it("CompareDeep does not mutate source object", () => {
    ...
    const target = {
      teams: [{ name: "developers" }, { name: "marketing" }],
    };
    const source = {
      teams: ["developers"],
    };
